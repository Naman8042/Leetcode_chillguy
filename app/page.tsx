...
import HeroCarousel from "./_component/Herocarouel";
  ...
  {[
    {
      ...
      description: "Enter your LeetCode ID to view your problem-solving history, ranking, badges, and progress over time.",
      input: true,
      buttonText: "Analyse Profile",
    },
    {
      title: "Save Code Snippets",
      description: "Store and organize your favorite code snippets for quick access and reuse.",
      image: CodeSnip,
      link: "/codesnippet",
    },
    {
      title: "Recursion Tree Visualization",
      description: "Visualize recursion trees for your code to understand function call structures better.",
      image: Recursion_tree,
      link: "/code",
    },
    {
      title: "Code Execution Flow",
      description: "Understand your program's execution order for easier debugging and logic tracing.",
      image: Code_Execution,
      link: "/execution",
    },
    {
      title: "Compare Profiles",
      description: "Compare your LeetCode profile with others to see how your problem-solving skills stack up.",
      image: Compare,
      link: "/compare",
    },
  ].map((item, index) => (
    ...
    >
      ...
      {item.image && (
        <div className="flex items-center justify-center mt-4">
          <Image src={item.image} alt={item.title} className="h-32 w-40 object-cover rounded-lg shadow-md" />
        </div>
      )}
    </div>
  ))}
